...
RMSE_Results <- data.frame(Method = "Model 1: Average Movie Rating", RMSE = RMSE_1)
...
# Calculated Predicted Ratings with Movie & User Effect
...
# Lambda is the tuning parameter; Uses cross-validation to choose ideal lambda for model
lambdas <- seq(0, 10, .25)
...
# Determine RMSE_5 - Regularized Model
RMSE_5 = min(RMSES)
...
## Model IX: Final Model - Regularization of the Movie and User Effect Model             
